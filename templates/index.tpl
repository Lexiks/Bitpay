...
{/literal}
<body>
Ваш аккаунт : <b id='account'>{$user_name}</b> <br>
...
<tr><td class="info_col">Ваш текущий BTC баланс:</td> <td><b id='current_btc_balance'>{$current_btc_balance}</b><td class="button_col"> <a href href="/jse.html" target="_blank" onclick="refresh_btc_balance();return false">Обновить BTC баланс</a></td> </tr>
<tr><td class="info_col">Ваш текущий USD баланс:</td> <td><b id='current_usd_balance'>{$current_usd_balance}</b><td class="button_col"> <a href href="/jse.html" target="_blank" onclick="refresh_usd_balance();return false">Обновить USD баланс</a></td> </tr>
<tr><td colspan="2"><span id="checkout">&nbsp;</span></td><td class="button_col"><a href href="/jse.html" target="_blank" onclick="DoCheckout();return false">Перевести BTC в USD</a></td>  <br></tr>
</table>
<br>
<div id="transaction_list">&nbsp;</div>
<a href href="/jse.html" target="_blank" onclick="refresh_transactions();return false">Обновить транзакции</a>
</body>
</html>